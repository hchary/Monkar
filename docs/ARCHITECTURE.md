...
worldData/monsters/items/{id}      -- the bestiary: what a generated mission hunts, replacing the
  ...
  -- page"); worldData/areas/items still has no page of its own, and no handler reads either
  -- collection yet - see docs/TODO.md rows 4, 5 and 8
