...
worldData/areas/items/{id}         -- terrain catalog: the type of place a region sits in.
  ...
  -- Written by AreasManager.jsx (the "Zones" creator tab); a region points at one through its
  -- areaId above. No handler reads it yet - see docs/TODO.md rows 5 and 8
...
worldData/monsters/items/{id}      -- the bestiary: what a generated mission hunts, replacing the
  ...
  -- page"); no handler reads it yet - see docs/TODO.md rows 5 and 8
