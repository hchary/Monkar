...
// system").
const MISSIONS_REQUIRED_BASE = 5;
const REPUTATION_PER_DISCOUNT = 20;
const MISSIONS_REQUIRED_MIN = 1;

function missionsRequiredForRenseignement(reputation) {
