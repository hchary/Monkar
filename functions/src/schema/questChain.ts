...
// { monsterId, difficulty } mission steps (functions/src/lib/questChains.js resolves step 1
// normally through the regular mission draw, then offers each later step exclusively once the
// previous one succeeds - see docs/TODO.md "Composite quests" and "Mission generation from the
// bestiary", which re-keyed the steps off the bestiary). No creator UI - authored directly in the
// Firestore console.
//
